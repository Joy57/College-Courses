...
int main() {
	...
	Player *team[5]; // Make a team of pointers to players.
					 ...
					 // means value stored inside the pointer becomes the address it's pointing to, which is player
	team[0] = &player;
	team[1] = &player1;
	team[2] = &player2;
	team[3] = &player3;
	...
	//for loop is used to repeat a section of code known number of times.In this case, we do not know or the computer does not know each player's capability or number of tackles one can take. Each defense and offense player don't follow any specific sequence of number, in other word, it's more dynamic. Hence, we do not use a for loop. 
